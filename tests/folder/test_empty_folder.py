...
from tests.folder.folder_data import Folder
...
def test_empty_folder_message(new_item_page: NewItemPage):
    ...
    message = folder_config_page.header.go_to_the_main_page().go_to_folder_page(Folder.FOLDER_NAME).get_empty_state_message()
