...
def test_display_error_page_content(new_item_page: NewItemPage, new_item_page_for_copy):
    error_page = new_item_page_for_copy.go_to_error_page_copy(Copy.COPY_NAME, Copy.NON_EXISTENT_FOLDER_NAME)
