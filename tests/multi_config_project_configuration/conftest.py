...
from tests.multi_config_project_configuration.data import ProjectToggle, project_name
...
def multi_config_project_with_description(new_item_page):
    from tests.multi_config_project_configuration.data import project_name, description_text
