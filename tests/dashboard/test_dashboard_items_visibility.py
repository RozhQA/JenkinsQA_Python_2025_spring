...
def test_all_jobs_and_folders_visible_in_dashboard(create_job_and_folders, main_page):
    ...
    folder_contents = main_page.click_on_folder_item(new_folder_name).get_item_list()
