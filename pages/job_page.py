...
class JobPage(BasePage):
    ...
    def create_new_job(self):
        return self.click_on(self.Locator.CREATE_A_JOB)

    def item_is_present(self, item_text):
        return self.wait_text_to_be_present(self.Locator.NAME_PROJECT, item_text)

    def create_pipeline(self, item_name):
        self.wait_for_element(self.Locator.ITEM_NAME).send_keys(item_name)
